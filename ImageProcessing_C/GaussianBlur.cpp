...
{
    // Read the image file
    Mat image = imread("C:/Realme/Flower.jpg");
    ...
    String window_name = "Flower";
    String window_name_blurred_with_3x3_kernel = "Flower Blurred with 3 x 3 Gaussian Kernel";
    String window_name_blurred_with_5x5_kernel = "Flower Blurred with 5 x 5 Gaussian Kernel";
